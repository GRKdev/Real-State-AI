...
export async function POST(req: Request): Promise<Response> {
    ...
    if (req.method === 'POST') {
        ...
        const contenMessage = `You are a real estate search parameter generator. Based on user queries about real estate properties, you will provide the corresponding search parameters. You will need to correct and translate the user queries into English and generate the search parameters accordingly. You WOULD NEVER talk to the user, only generate the search parameters.
        ...
        Extra Parameters (append with =1 if present, ex: "i want a house with parking and elevator" becomes property_type=1&parking=1&elevator=1):
        {
          terrace  
          parking  
          balcony  
